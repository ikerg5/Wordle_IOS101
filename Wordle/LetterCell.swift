...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    ...
    // ...
      ...
      case .incorrect:
        let c = UIColor(red: 0.23, green: 0.23, blue: 0.24, alpha: 1.0)
        contentView.backgroundColor = c
        layer.borderColor = c.cgColor

      case .correctLetterOnly:
        let c = UIColor(red: 0.69, green: 0.63, blue: 0.30, alpha: 1.0)
        contentView.backgroundColor = c
        layer.borderColor = c.cgColor

      case .correctLetterAndPosition:
        let c = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1.0)
        contentView.backgroundColor = c
        layer.borderColor = c.cgColor
      }
    // END YOUR CODE HERE
